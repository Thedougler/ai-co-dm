...
Claustrophobic side tubes become shelter — it can't turn sharp at full speed.

## Role / dials
- **Easy:** juveniles only (use giant centipede chassis; adult absent — cannibalistic).
- **Hard:** full Tunnel Rush in the Great Bore with nowhere to sidestep.
- **Bloodied:** still pins; may break off if prey reaches a crawlway it can't enter.

## Signature moves
Tunnel Rush · Pin + venom · tremorsense telegraph

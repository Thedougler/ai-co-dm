...
role: skirmisher
cr: 2
source: house (juvenile Bloodhawk pressure variant; 2024 CR 2 conversion)
visibility: dm
tags: [monster, aruhe]
summary: CR 2 juvenile Bloodhawk that follows an adult's dive and drives exposed airborne bodies toward the ground.
---
# Young Bloodhawk
...
traits:
  ...
  - name: Sculpted Predator
    desc: "The young bloodhawk's weapon attacks are magical."
actions:
  - name: Multiattack
...
**Behavior.** A young Bloodhawk is a smaller charcoal four-winged hawk with a ragged red crest and narrow body. It circles behind an adult, waits for the larger bird to break a body out of cover, and then drops after whatever falls into the open.
...
**Tactics.** It follows the adult's Canopy Dive, then uses Flush Dive on a body that remains airborne or has just been driven from cover. It uses Multiattack only when a target cannot reach cover and abandons the line when the adult breaks off.

...
| **Agentic-System-Designer** | Same role as skill `agentic-system-designer` (also Grok Build, Codex, omp). This bot: packets **Ops** / **Skill-Creator** / **Team-Leader** / **dr eggbot**; owns inbound friction reports, [[user-corrections]] drain, weekday **8am PT** `daily-agentic-optimization`. Not day-to-day AGENTS/scripts/qmd (**Ops**), not CreateAgent (**dr eggbot**), not production `SKILL.md` (**Skill-Creator**), not roster triage (**Team-Leader**) |

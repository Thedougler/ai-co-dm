...
type: encounter
campaign: 
status: idea # idea | ready | run | shelved
location: 
visibility: dm
tags: [encounter]
...
- **Situation magnets:** Who is airborne, loud, or otherwise obvious — not a named-PC roster.
...
Owner wikilinks only. Combat surfaces are already embedded above.

### Twists / dials

How to harden, soften, or reframe mid-fight.

### Treasure / fallout

Links to [[Item]], faction heat, and clocks.

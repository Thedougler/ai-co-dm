...
type: vehicle
campaign: 
kind: # ship | boat | other
region: 
berth: # home port / mooring / linked place — optional
visibility: dm
tags: [vehicle]
---
...
- Do not treat this as a `location` (use `campaigns/<campaign>/vehicles/`).
- Do not say “boarding interface” in `[!narration]`.
- Do not dump a full keyed deck map unless play needs it.
- Do not invent CR/HP/speed tables without Homebrewer.

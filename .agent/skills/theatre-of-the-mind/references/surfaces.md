...
| Technique (`kind: technique`) | Cold `[!narration]` is a **tell portrait**: breath/stance/wing set and training place as stable character. Not an object inventory; not a resolved strike film. | Stop before the blow lands; effects stay Fiction/Mechanics/At the table. |
